...
inputs.brand.addEventListener("input", (e) => {
  ...
  let feedback = fieldset.querySelector(".edit_msg-error-front.brand");
  let msg = null;
...
inputs.type.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.type");
  let msg = null;
...
inputs.price.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.price");
  let msg = null;
...
inputs.alcohol.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.alcohol");
  let msg = null;
...
inputs.acidez.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.acidez");
  let msg = null;
...
inputs.azucar.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.azucar");
  let msg = null;
...
inputs.vista.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.vista");
  let msg = null;
...
inputs.nariz.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.nariz");
  let msg = null;
...
inputs.boca.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.boca");
  let msg = null;
...
inputs.otros.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.otros");
  let msg = null;
...
inputs.image.addEventListener("change", (e) => {
  ...
  let box = e.target.parentElement;
  let feedback = fieldset.querySelector(".edit_msg-error-front.image");
  let msg = null;
