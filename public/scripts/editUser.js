...
inputs.nombre.addEventListener("input", (e) => {
  ...
  let feedback = fieldset.querySelector(".edit_msg-error-front.nombre");
  let msg = null;
...
inputs.apellido.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.apellido");
  let msg = null;
...
inputs.avatar.addEventListener("change", (e) => {
  ...
  let box = e.target.parentElement;
  let feedback = fieldset.querySelector(".edit_msg-error-front.avatar");
  let msg = null;
...
inputs.fechaNacimiento.addEventListener("input", (e) => {
  ...
  let feedback = fieldset.querySelector(
    ".edit_msg-error-front.fechaNacimiento"
  );
  let msg = null;
...
inputs.password.addEventListener("input", (e) => {
  ...
  let box = e.target.parentElement;
  let value = e.target.value;
  let feedback = fieldset.querySelector(".edit_msg-error-front.password");
  let msg = null;
...
inputs.passwordConfirmada.addEventListener("input", (e) => {
  ...
  let value = e.target.value;
  let feedback = fieldset.querySelector(
    ".edit_msg-error-front.passwordConfirmada"
  );
  let msg = null;
